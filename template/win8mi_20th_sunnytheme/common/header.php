...
<div class="whole_box cl">
<div id="headnav" {if $_GET['diy'] == 'yes' && check_diy_perm($topic)}class="hides"{/if}>
  <div class="wp cl">
     <!--{ad/headerbanner/wp a_h}-->
  </div>
  <div class="wp wp_logo cl">
      <!-- 站点LOGO -->
      <div class="hd_logo"> 
         <!--{eval $mnid = getcurrentnav();}-->
		 <h2><a href="portal.php"><img src="template/win8mi_20th_sunnytheme/src/logo.png" /></a></h2>
      </div>
      <div class="ad_top_right cl">
  ...
  <div id="topbar" class="cl"> 
    <div class="wp cl">
      ...
      <div class="yp-header-user-box">
        <div class="yp-header-user">
          <div class="user-main ">
            <div class="avatar"> <img src="template/win8mi_20th_sunnytheme/src/noLogin.jpg" alt="" height="32" width="32"></div>
            <span class="nickname">{$_G[member][username]}</span><span class="arrow"></span></div>
          <div class="user-link">
            <ul>
