...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:wb="http://open.weibo.com/wb">
	...
	<!--{csstemplate}-->
    <script type="text/javascript" src="template/win8mi_20th_sunnytheme/src/js/jquery.min.js"></script>
    <script type="text/javascript" src="template/win8mi_20th_sunnytheme/src/js/jquery.superslide.js"></script>
