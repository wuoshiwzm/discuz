...
<?php echo '<hook>[string viewthread_poll_top]</hook>';if(!empty($_G['setting']['pluginhooks']['viewthread_poll_top'])) echo $_G['setting']['pluginhooks']['viewthread_poll_top'];?>
...
<?php echo '<hook>[string viewthread_poll_bottom]</hook>';if(!empty($_G['setting']['pluginhooks']['viewthread_poll_bottom'])) echo $_G['setting']['pluginhooks']['viewthread_poll_bottom'];?>
