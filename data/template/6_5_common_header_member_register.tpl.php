...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1482806310, '5', './data/template/6_5_common_header_member_register.tpl.php', './template/forum', 'common/header_member_register')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1482806310, '5', './data/template/6_5_common_header_member_register.tpl.php', './template/forum', 'common/header_member_register')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1482806310, '5', './data/template/6_5_common_header_member_register.tpl.php', './template/forum', 'common/header_member_register')
;?>
