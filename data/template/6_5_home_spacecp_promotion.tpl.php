...
0
|| checktplrefresh('./template/default/home/spacecp_promotion.htm', './template/default/home/spacecp_header.htm', 1482746107, '5', './data/template/6_5_home_spacecp_promotion.tpl.php', './template/forum', 'home/spacecp_promotion')
|| checktplrefresh('./template/default/home/spacecp_promotion.htm', './template/default/home/spacecp_footer.htm', 1482746107, '5', './data/template/6_5_home_spacecp_promotion.tpl.php', './template/forum', 'home/spacecp_promotion')
|| checktplrefresh('./template/default/home/spacecp_promotion.htm', './template/default/home/spacecp_header_name.htm', 1482746107, '5', './data/template/6_5_home_spacecp_promotion.tpl.php', './template/forum', 'home/spacecp_promotion')
|| checktplrefresh('./template/default/home/spacecp_promotion.htm', './template/default/home/spacecp_header_name.htm', 1482746107, '5', './data/template/6_5_home_spacecp_promotion.tpl.php', './template/forum', 'home/spacecp_promotion')
...
<?php echo $_G['setting']['plugins'][$pluginkey][$_GET['id']]['name'];?>
<?php } ?></h1>
<!--don't close the div here--><?php echo '<hook>[string spacecp_promotion_top]</hook>';if(!empty($_G['setting']['pluginhooks']['spacecp_promotion_top'])) echo $_G['setting']['pluginhooks']['spacecp_promotion_top'];?>
...
<?php } ?>
<?php echo '<hook>[string spacecp_promotion_bottom]</hook>';if(!empty($_G['setting']['pluginhooks']['spacecp_promotion_bottom'])) echo $_G['setting']['pluginhooks']['spacecp_promotion_bottom'];?>
</div>
</div>
