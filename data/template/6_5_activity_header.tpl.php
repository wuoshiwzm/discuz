...
0
|| checktplrefresh('./template/default/activity/header.htm', './template/default/common/header_common.htm', 1482819256, '5', './data/template/6_5_activity_header.tpl.php', './template/forum', 'activity/header')
|| checktplrefresh('./template/default/activity/header.htm', './template/default/common/header_qmenu.htm', 1482819256, '5', './data/template/6_5_activity_header.tpl.php', './template/forum', 'activity/header')
|| checktplrefresh('./template/default/activity/header.htm', './template/default/common/pubsearchform.htm', 1482819256, '5', './data/template/6_5_activity_header.tpl.php', './template/forum', 'activity/header')
;?>
