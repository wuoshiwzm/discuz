...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1482830400, '5', './data/template/6_5_common_header_forum_post.tpl.php', './template/forum', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1482830400, '5', './data/template/6_5_common_header_forum_post.tpl.php', './template/forum', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1482830400, '5', './data/template/6_5_common_header_forum_post.tpl.php', './template/forum', 'common/header_forum_post')
;?>
