...
0
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/header.htm', 1482810900, '5', './data/template/6_5_search_forum.tpl.php', './template/forum', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/pubsearch.htm', 1482810900, '5', './data/template/6_5_search_forum.tpl.php', './template/forum', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/thread_list.htm', 1482810900, '5', './data/template/6_5_search_forum.tpl.php', './template/forum', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/footer.htm', 1482810900, '5', './data/template/6_5_search_forum.tpl.php', './template/forum', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/common/header_common.htm', 1482810900, '5', './data/template/6_5_search_forum.tpl.php', './template/forum', 'search/forum')
;?>
...
<?php echo '<hook>[string global_usernav_extra1]</hook>';if(!empty($_G['setting']['pluginhooks']['global_usernav_extra1'])) echo $_G['setting']['pluginhooks']['global_usernav_extra1'];?>
...
<?php echo '<hook>[string global_usernav_extra2]</hook>';if(!empty($_G['setting']['pluginhooks']['global_usernav_extra2'])) echo $_G['setting']['pluginhooks']['global_usernav_extra2'];?>
...
<?php } ?><?php echo '<hook>[string forum_top]</hook>';if(!empty($_G['setting']['pluginhooks']['forum_top'])) echo $_G['setting']['pluginhooks']['forum_top'];?><?php $policymsgs = $p = '';?><?php if(is_array($_G['setting']['creditspolicy']['search'])) foreach($_G['setting']['creditspolicy']['search'] as $id => $policy) { ?><?php
$policymsg = <<<EOF
...
<?php echo '<hook>[string forum_bottom]</hook>';if(!empty($_G['setting']['pluginhooks']['forum_bottom'])) echo $_G['setting']['pluginhooks']['forum_bottom'];?><?php $focusid = getfocus_rand($_G[basescript]);?><?php if($focusid !== null) { $focus = $_G['cache']['focus']['data'][$focusid];?><div class="focus" id="focus">
<div class="bm">
<div class="bm_h cl">
...
<?php echo '<hook>[string global_footerlink]</hook>';if(!empty($_G['setting']['pluginhooks']['global_footerlink'])) echo $_G['setting']['pluginhooks']['global_footerlink'];?>
