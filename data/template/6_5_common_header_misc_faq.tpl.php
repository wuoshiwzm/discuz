...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1482822201, '5', './data/template/6_5_common_header_misc_faq.tpl.php', './template/forum', 'common/header_misc_faq')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1482822201, '5', './data/template/6_5_common_header_misc_faq.tpl.php', './template/forum', 'common/header_misc_faq')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1482822201, '5', './data/template/6_5_common_header_misc_faq.tpl.php', './template/forum', 'common/header_misc_faq')
;?>
