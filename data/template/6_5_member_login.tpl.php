...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1482806222, '5', './data/template/6_5_member_login.tpl.php', './template/forum', 'member/login')
