...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1482823624, '5', './data/template/6_5_common_header_portal_view.tpl.php', './template/forum', 'common/header_portal_view')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1482823624, '5', './data/template/6_5_common_header_portal_view.tpl.php', './template/forum', 'common/header_portal_view')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1482823624, '5', './data/template/6_5_common_header_portal_view.tpl.php', './template/forum', 'common/header_portal_view')
;?>
